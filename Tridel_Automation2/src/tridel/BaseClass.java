...
public class BaseClass {
	...
	public Properties loadConfiguration(String fileName) throws IOException {
		...
		FileInputStream fis = new FileInputStream(
				"D:\\EclipseWorkspace\\Tridel_Automation\\src\\configs\\" + fileName);
	...
	public void writeConfig(String fileName, String key, String value) throws IOException {
		...
		// Windows
		output = new FileOutputStream("D:\\EclipseWorkspace\\Tridel_Automation\\src\\configs" + fileName);
	...
	// Print Webelement
	public void printf(WebElement webElement) {
		System.out.println(webElement);
	}
		
	public void clickAction(Properties prop, String path ) throws Throwable 							
	{		
	    findElement(prop, path).click();
	    print("Click on the : "+findElement(prop, path).getText());
	}
	
	public void enterValue(Properties prop, String path, String inputValue) throws Throwable 							
	{		
	    findElement(prop, path).sendKeys(inputValue);
	    print("Enter value into the field: "+findElement(prop, path).getText()+" "+inputValue);
	}
	
	public void selectfromDropDown(Properties prop, String path, String visibleText) throws Throwable 							
	{	
		// Going to select from drop-down list
		org.openqa.selenium.support.ui.Select drpItem = new org.openqa.selenium.support.ui.Select(findElement(prop, path));
		drpItem.selectByVisibleText(visibleText);
	    print("Select item from dropdown list:"+visibleText);
	}
